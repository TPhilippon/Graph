...
for myfile in files:
    ...
    while i <= p:
        ...
        ZIl3dR=np.dot(ZIl3d,1.0) #   transformation en objet numpy pour manipuler plus facilement
        ...
        filen = data_out+myfile[0:38]+'_ZI' #'A'+str(a)+str(format(day,'03'))+str(a)+str(format(day2,'03'))
        print filen+str(i)
